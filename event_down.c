...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/31 12:26:33 by oouazize          #+#    #+#             */
/*   Updated: 2022/01/31 12:26:33 by oouazize         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	lines(t_data *data)
{
	...
	data->count++;
	mlx_string_put(data->mlx, data->win, ft_len(data->str) * 50 / 34 + 70,
		15, 0x00FFFFFF, ft_itoa(data));
	free(data->ito);
}
